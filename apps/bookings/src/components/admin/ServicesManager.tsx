  ...
  const [services, setServices] = useState<Service[]>([
    {
      ...
      enabled: true,
      description: "Professional music recording session",
    },
    {
      id: "2",
      name: "Music Video",
    ...
    },
    {
      ...
      info: "Premium package pricing",
      enabled: true,
      description: "Our premium all-inclusive package",
    },
  ]);
                  ...
                  .map((service) => (
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="text-teal-400 text-sm">{service.info}</p>
                      </div>
      ...
      {editingService && (
        <Card className="bg-slate-900 border-teal-500">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <Label htmlFor="info" className="text-white">
                Pricing Info
              </Label>
              <Input
                id="info"
                value={editingService.info}
                onChange={(e) =>
                  setEditingService((prev) =>
                    prev ? { ...prev, info: e.target.value } : null,
                  )
                }
                className="bg-gray-800 border-gray-600 text-white"
